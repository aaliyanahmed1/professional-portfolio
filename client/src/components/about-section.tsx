    ...
    <section id="about" className="section-padding bg-background">
      <div className="container mx-auto container-padding">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <img
              src="/attached_assets/WhatsApp Image 2025-07-05 at 01.22.16_55149d4a_1751667280472.jpg"
              alt="Professional headshot of AI engineer Aaliyan Ahmed"
              className="rounded-2xl shadow-lg w-full max-w-md mx-auto"
            />
          </div>
          <div>
            <h3 className="text-2xl font-bold text-foreground mb-4">AI Engineer | Computer Vision Specialist</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Bachelor's in Artificial Intelligence (BS AI)</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">3+ years as AI Engineer (freelance)</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <Trophy className="text-accent text-xl mt-1" />
                <div>
                  <h4 className="font-semibold text-foreground">Projects Delivered</h4>
                  <p className="text-muted-foreground">Multiple successful AI projects for global clients</p>
                </div>
              </div>
            </div>
          </div>
